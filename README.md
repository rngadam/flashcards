...
- **Smart "Don't Know" Logic:** When you mark a card as not known, its score is reset, and the app will show you a _different_ card from the pool of least-known cards, preventing immediate repeats.
...
_Note: The `DEFANG_HOST` environment variable is automatically injected by the platform and used to construct the callback URLs._
