/**
 * @file Utility functions for handling card statistics.
 */

/**
 * Merges two card statistics objects, combining their success/failure timestamps,
 * response delays, and view counts. It takes the more recent lastViewed timestamp
 * and the higher intervalIndex.
 * @param {object} existing - The existing card stats object.
 * @param {object} imported - The new card stats object to merge from.
 * @returns {object} The merged card stats object.
 */
